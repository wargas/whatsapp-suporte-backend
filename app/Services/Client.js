...
const { WhatsWebURL, DefaultOptions, Events, WAState } = require('whatsapp-web.js/src/util/Constants');
const { ExposeStore, LoadUtils } = require('whatsapp-web.js/src/util/Injected');
const ChatFactory = require('whatsapp-web.js/src/factories/ChatFactory');
const ContactFactory = require('whatsapp-web.js/src/factories/ContactFactory');
const { ClientInfo, Message, MessageMedia, Contact, Location, GroupNotification, Label, Call } = require('whatsapp-web.js/src/structures');
/**
...
class Client extends EventEmitter {
    ...
    async getChatById(chatId) {
        console.log('Client.js[581]', chatId)
        try {
